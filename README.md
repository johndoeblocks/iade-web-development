...
1. **Lê os ficheiros `.md`** em cada pasta `docs/` - explicam os conceitos
2. **Estuda o código** nos ficheiros `.jsx` e `.js`
3. **Experimenta** fazer alterações e ver o resultado

## 🙏 Créditos & Inspiração

- [Brian Holt - Complete Intro to React v9](https://react-v9.holt.courses/)
- [Scott Moss - Intro to Node.js v3](https://frontendmasters.com/courses/node-js-v3/)
